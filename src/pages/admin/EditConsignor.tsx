...
const EditConsignor = () => {
  ...
  const [formData, setFormData] = useState({
    name: mockConsignor.name,
    cpf: mockConsignor.cpf,
    email: mockConsignor.email,
    phone: mockConsignor.phone,
    paymentMethod: mockConsignor.paymentMethod,
    pixKey: mockConsignor.pixKey,
    bankAccount: mockConsignor.bankAccount,
  });
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    console.log('Consignante a ser atualizado:', formData);
      ...
      <div className='w-full max-w-7xl mx-auto'>
        <div className='mb-8'>
          ...
          <p className='text-sm sm:text-base text-slate-600'>
            Atualize as informações do consignante abaixo
          </p>
        </div>
