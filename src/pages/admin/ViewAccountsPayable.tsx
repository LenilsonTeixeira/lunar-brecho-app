import { ArrowLeft, DollarSign, Calendar, Building2, FileText } from 'lucide-react';
      ...
      <div className='w-full max-w-7xl mx-auto'>
        <div className='mb-8'>
          ...
          <h1 className='text-2xl sm:text-3xl font-bold text-slate-800 mb-2'>
            Conta a Pagar #{mockAccount.id}
          </h1>
          <p className='text-sm sm:text-base text-slate-600'>Detalhes completos da conta a pagar</p>
        </div>
        ...
        <div className='bg-white rounded-xl shadow-lg p-4 sm:p-6 lg:p-8 space-y-6'>
          ...
          <div className='p-6 bg-slate-50 rounded-lg border border-slate-200'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              <div>
                ...
                <div className='p-3 bg-white rounded-lg border border-slate-200'>
                  <span className='text-slate-800'>{mockAccount.supplier}</span>
                </div>
              </div>
              ...
              <div>
                ...
                <div className='p-3 bg-white rounded-lg border border-slate-200'>
                  <span className='text-slate-800'>{mockAccount.supplierPhone}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='pt-6 border-t border-slate-200'>
            <div className='flex flex-col sm:flex-row justify-end gap-3 sm:gap-4'>
              ...
              <button
                onClick={() => navigate(`/admin/contas-pagar/editar/${mockAccount.id}`)}
