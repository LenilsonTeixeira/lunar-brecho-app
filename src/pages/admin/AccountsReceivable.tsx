...
const AccountsReceivable = () => {
  ...
  const [accounts] = useState<AccountsReceivableItem[]>([
    {
      id: 1,
      ...
      <div className='w-full max-w-7xl mx-auto'>
        ...
        <div className='mb-8'>
          <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
            ...
            <Link
              to='/admin/contas-receber/adicionar'
              className='flex items-center justify-center gap-2 sm:px-4 py-3 sm:py-3 bg-gradient-to-r from-green-600 to-emerald-500 text-white font-semibold rounded-lg hover:from-green-700 hover:to-emerald-600 transform hover:scale-105 transition-all duration-300 shadow-lg'
            >
