    ...
    >
      <div className='space-y-6'>
                ...
                <div className='flex items-center justify-between mt-3'>
                  <div className='flex items-center gap-2'>
                    ...
                    <button
                      ...
                      className='w-7 h-7 flex items-center justify-center rounded-md border border-gray-300 hover:bg-gray-50 transition-colors'
        ...
        <div className='space-y-3 pt-4'>
          <button
            onClick={closeCartDrawer}
            className='w-full border border-gray-300 text-gray-900 py-3 rounded-lg font-semibold transition-colors hover:bg-gray-50'
          >
            CONTINUAR COMPRANDO
          </button>
          ...
          <Link
            to='/checkout'
            onClick={closeCartDrawer}
            className='w-full bg-gray-900 hover:bg-gray-800 text-white py-3 rounded-lg font-semibold transition-colors inline-block text-center'
          >
